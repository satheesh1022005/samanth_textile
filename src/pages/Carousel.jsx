  ...
  const carouselItems = [
    {
      ...
      passage: 'This is a passage about Company One. It provides excellent services and products.',
    },
    {
      image: 'https://picsum.photos/id/1025/800/400', // Random image from Picsum
      companyName: 'Samanth Textiles',
      passage: 'This is a passage about Company Two. Known for its innovative solutions.',
    },
    {
      image: 'https://picsum.photos/id/1035/800/400', // Random image from Picsum
      companyName: 'Samanth Textiles',
      passage: 'This is a passage about Company Three. Committed to customer satisfaction.',
    },
  ];
        ...
        {carouselItems.map((item, index) => (
          <div key={index} className="carousel-item">
            ...
            <div className="carousel-content">
              ...
              <p>{item.passage}</p>
              <button className='explore-btn'>Explore<span className='right-arrow'>&#8250;</span></button>
            </div>
          </div>
        ))}
      </Slider>
